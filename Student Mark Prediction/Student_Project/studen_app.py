# Student Marks Prediction Based on Study Houre
import numpy as np
import pandas as pd
...
app = Flask(__name__)
model = joblib.load(r"C:\Users\USER\Desktop\capstone project\Student Mark Prediction\Student_Project\Student_mark_prediction.pkl")
